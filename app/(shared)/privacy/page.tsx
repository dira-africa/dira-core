        ...
        <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1 custom-scrollbar">
          {locale === "en" ? (
            <div className="space-y-4 text-xs text-white/70 leading-relaxed">
              ...
              <h2 className="text-sm font-bold text-white pt-2 border-t border-white/5">
                4. Data Protection & Midnight Blockchain
              </h2>
              <p>
                Data integrity is anchored weekly to the Midnight blockchain. This anchoring uses Compact smart contracts to verify datasets without exposing any personal identifiers, names, or GPS locations publicly. All phone numbers are locked using encryption keys kept strictly off-database.
              </p>
            ...
            <div className="space-y-4 text-xs text-white/70 leading-relaxed">
              ...
              <h2 className="text-sm font-bold text-white pt-2 border-t border-white/5">
                4. Ulinzi wa Data & Midnight Blockchain
              </h2>
              <p>
                Uaminifu wa data unathibitishwa kila wiki kwenye blockchain ya Midnight kwa kutumia mikataba ya Compact. Mchakato huu haufichui jina, nambari ya simu, au eneo halisi la GPS la mtumiaji yeyote kwa umma.
              </p>
