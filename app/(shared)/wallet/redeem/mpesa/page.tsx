...
const mpesaTranslations = {
  en: {
    ...
    processingDesc: "We have debited your Climate Tokens and sent the request to the mobile money provider. Waiting for confirmation callback...",
    ...
    serviceUnavailable: "Mobile money payouts are currently disabled. Please use Airtime or try again later.",
  ...
  sw: {
    ...
    processingDesc: "Tumekata Climate Tokens zako na kutuma ombi kwa mtoa huduma wa pesa za simu. Tunangojea uthibitisho...",
    ...
    serviceUnavailable: "Malipo ya pesa za simu yamelemazwa kwa sasa. Tafadhali tumia Muda wa Maongezi au jaribu tena baadaye.",
